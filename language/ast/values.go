...
// MapValue implements Node, Value
...
func NewMapValue(v *MapValue) *MapValue {
	if v == nil {
		v = &MapValue{}
	}
	return &MapValue{
...
func (v *MapValue) GetKind() string {
	return v.Kind
}

func (v *MapValue) GetLoc() *Location {
	return v.Loc
}
...
func (v *MapValue) GetValues() interface{} {
	// TODO: verify ObjectValue.GetValue()
	return v.Values
}
